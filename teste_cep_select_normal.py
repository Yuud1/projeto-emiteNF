...
# -*- coding: utf-8 -*-
"""
Script de teste para verificar funcionalidade do CEP com select normal da inscrição municipal
"""
...
def testar_cep_select_normal():
    """Testa a funcionalidade do CEP com select normal da inscrição municipal"""
    
    try:
        logger.info("=== TESTE CEP COM SELECT NORMAL ===")
...
if __name__ == "__main__":
    success = testar_cep_select_normal()
