...
# -*- coding: utf-8 -*-
"""
Teste da função fill_nfse_servicos_sem_scroll usando dados reais do PDF
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('logs/test_step3_sem_scroll.log', encoding='utf-8'),
...
def main():
    ...
    try:
        logger.info("=== INICIANDO TESTE STEP 3 SEM SCROLL (DADOS REAIS) ===")
        ...
        logger.info("🚀 Navegador mantido aberto para inspeção do modal")
